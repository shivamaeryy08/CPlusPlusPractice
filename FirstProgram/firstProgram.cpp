...
int main(){ // Main function, starting point of c++ program or entry point of program
    ...
    std::cout << "Number1"; //Simisalr to system.oput.print in java, no newline wihtout endl
    std::cout <<"Number2";
    return 0; // main function sneding message to os if it finished succesffuly 0 = success, otherwise problem
}